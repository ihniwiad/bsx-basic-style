...
( function( $, Utils ) {
	...
	var createTicket = function( $form ) {
    ...
    Utils.$window.on( Utils.events.initJs, function() {
	    ...
	    Utils.$functionElems.filter( '[data-fn="create-ticket"]' ).each( function() {
	        $( this ).initCreateTicket();
	    } );
